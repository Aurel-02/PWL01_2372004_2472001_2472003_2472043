<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="font-black text-4xl text-white leading-tight tracking-tight uppercase">
                    BUAT <span class="text-secondary">EVENT BARU</span>
                </h2>
                <p class="text-pearl font-bold uppercase tracking-widest text-[10px] mt-2">Inisialisasi event baru ke dalam sistem Eventify.</p>
            </div>
    ...
    <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="5" 
                                class="w-full bg-gray-50 border-2 border-gray-100 focus:border-secondary focus:ring-0 rounded-3xl px-6 py-4 font-medium text-gray-600 transition-all"
                                placeholder="Jelaskan detail event, lineup, dan pengalaman yang akan didapat...">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="venue" value="{{ old('venue') }}"
                                class="w-full bg-gray-50 border-2 border-gray-100 focus:border-accent focus:ring-0 rounded-2xl px-6 py-4 font-bold text-primary transition-all"
                                placeholder="Gedung Serbaguna, Stadion, Cafe, dll...">
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full bg-gray-50 border-2 border-gray-100 focus:border-accent focus:ring-0 rounded-2xl px-6 py-4 font-bold text-primary transition-all">
                                <option value="draft" {{ old('status') == 'draft' ? 'selected' : '' }}>Draft (Hanya Admin)</option>
                ...
                <div class="p-12">
                    ...
                    <div class="relative group">
                        ...
                        <div class="bg-gray-50 border-4 border-dashed border-gray-100 rounded-[2rem] p-12 text-center group-hover:border-amber-500 group-hover:bg-amber-50 transition-all duration-300">
                            ...
                            <p class="font-black text-primary uppercase tracking-tight mb-1">Klik untuk Upload Banner</p>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Format: PNG, JPG (Maks. 2MB)</p>
                        </div>
                    </div>
